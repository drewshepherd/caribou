###################################################
##2D with heat genration that depends on time, couples heat conduction to burnup, uses contact
...
[Outputs]
  file_base = rmctests/2D/2D_simple_burnup_material_v1_out
  output_initial = true
  exodus = true
  print_perf_log = true
[]
