...
#		quadrature = true
		gap_temp = temp
		gap_distance = disp_x
#		paired_boundary = pellets_out
#		master = sheath_in
#		slave = pellets_out
		emissivity_fuel = 0.5
		emissivity_sheath = 0.5
		use_displaced_mesh = true
		cylindrical_gap = false
		display_values = true
	[../]
...
#time control
  start_time = 0.0
#  dt = 10.0
  end_time = 1.728e7 #200 days in the reactor
	num_steps = 5000
...
[Outputs]
  file_base = 2D_Paraview/2D_simple_v13_out
  output_initial = true
  exodus = true
