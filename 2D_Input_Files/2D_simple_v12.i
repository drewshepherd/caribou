...
#########################################################################################################################
##checking linear power burnup, use v11 for now
...
##Trelis geometry
[Mesh]
	file = 2D_Geometries/2D_simple_v1.e
...
[Functions]
	...
	[./linear_power_function_burnup]
		type = PiecewiseLinear
		x = '0 1e-3 1e-2 1e-1'#'0 3.265 17.088 29.626'
		y = '0 2e4 25e3 35e3'#'19860 20460 21330 24250'
	[../]
	[./pressure_ramp]
		type = PiecewiseLinear
		x = '0 1'
...
[Outputs]
  file_base = 2D_Paraview/2D_simple_v12_out
  output_initial = true
  exodus = true
