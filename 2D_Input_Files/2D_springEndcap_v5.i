...
##odd blotch is found when displacement is viewed in paraview with 16, 15, 13 cores. With 14 cores it diverges.
...
##Trelis geometry
[Mesh]
	file = 2D_Geometries/2D_springEndcap_v1.e
...
[BCs]
  ...
  [./X_in] ##Constrains the midline of the pellet to not move horizontally
    type = DirichletBC
    variable = disp_x
    boundary = 'pellets_in endcap_in spring_in'
    value = 0
  [../]
	[./Pressure]
		[./coolant_pressure]
...
[Outputs]
  file_base = 2D_Paraview/2D_springEndcap_v5_out
  output_initial = true
  exodus = true
  [./console]
    type = Console
