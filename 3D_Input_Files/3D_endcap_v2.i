...
##Trelis geometry
[Mesh]
	file = 3D_Geometries/3D_endcapcoarse.e
...
[BCs]
    ...
    boundary = 'sheath_out endcap_out endcap_bot'
		...
		coefficient = 5e4
	[../]
	[./Z] ##Constrains the top of the pellets and sheath to not move vertically
    type = DirichletBC
    variable = disp_z
    boundary = 'pellet2_top sheath_top'
    value = 0
  [../]
  [./X] ##Constrains the x-halfplane of the pellet to not move horizontally
    type = DirichletBC
    variable = disp_x
    boundary = 'pellets_in endcap_in sheath_in'
    value = 0
  [../]
	[./Y] ##Constrains the y movement
		type = DirichletBC
		variable = disp_y
		boundary = 'pellet1_point endcap_out'
		value = 0
	[../]
#	[./Pressure]
#		[./coolant_pressure]
...
[Materials]
    ...
    type = PelletThermalMaterial
		...
		model_thermal_conductivity = false
