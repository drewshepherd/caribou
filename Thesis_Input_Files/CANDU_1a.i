...
[./TestBC]
	type = DirichletBC
	variable = temp
	boundary = 'sheath_out sheath_in pellet_bot sheath_bot sheath_y sheath_x pellet_x pellet_y pellet_out'
	value = 550
[../]  
...
[Outputs]
  file_base = Thesis_Paraview/CANDU_1a_out
  output_initial = true
  exodus = true
  [./console]
    type = Console
